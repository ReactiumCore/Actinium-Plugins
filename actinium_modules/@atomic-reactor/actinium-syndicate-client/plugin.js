...
const MOD = () => {
     ...
     * ----------------------------------------------------------------------------
     */
    Actinium.SyndicateClient = Actinium.SyndicateClient || PLUGIN_SDK;
    ...
    Actinium.Hook.register('syndicate-client-sync-relations', async () => {
        const contentRelations = Actinium.Cache.get(
            'syndicate.contentRelations',
        );
        const context = {
            label: 'Relation',
