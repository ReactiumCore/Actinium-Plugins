 ...
 */
    ...
    Client.create = async (req, options) => {
        ...
        if (
            ...
            throw new Error(
                'Permission denied creating new syndication client.',
            );
        ...
        if (!client)
            throw new Error(
                'Client label required to create syndication client.',
            );
 ...
 */
    ...
    Client.list = async (req, options) => {
        ...
        if (
            ...
            throw new Error(
                'Permission denied retrieving syndication clients.',
            );
    ...
    Content.taxonomyTypes = async (req) => {
        ...
        const masterOptions = Actinium.Utils.MasterOptions();
        const result = await Actinium.Taxonomy.Type.list(
            req.params,
            masterOptions,
        );
